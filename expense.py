...
print("1. In Feb, how many dollars you spent extra compare to January?" ,exp[1]-exp[0])
print("2. Find out your total expense in first quarter (first three months) of the year.",sum(exp[:3]))
